...
export default function ContactFormWithSocialButtons() {
  const { hasCopied, onCopy } = useClipboard('contacto@vefixy.com');
          ...
          <VStack spacing={{ base: 4, md: 8, lg: 20 }}>
            ...
            <Stack spacing={{ base: 4, md: 8, lg: 20 }} direction={{ base: 'column', md: 'row' }}>
              <Stack align="center" justify="space-around" direction={{ base: 'row', md: 'column' }}>
                <Tooltip label={hasCopied ? '¡Se ha copiado el correo!' : 'Copiar correo'} closeOnClick={false} hasArrow>
                  <IconButton
                    aria-label="email"
                    variant="ghost"
                    size="lg"
                ...
                <Box as="a" href="https://twitter.com/vefixy">
                  <IconButton
                    aria-label="twitter"
                    variant="ghost"
                    size="lg"
                ...
                <Box as="a" href="https://linkedin.com/company/vefixy">
                  <IconButton
                    aria-label="linkedin"
                    variant="ghost"
                    size="lg"
              ...
              >
                <VStack spacing={5}>
                  ...
                  <FormControl isRequired>
                    ...
                    <Textarea name="message" placeholder="Ingresa un breve mensaje y nos contactaremos." rows={6} resize="none" />
                  </FormControl>
